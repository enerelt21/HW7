...
public:
	...
	void show_stats()
	{
		...
		double w = landing_queue->get_total_wait();
		double n = landing_queue->get_num_served();
		std::cout << "Average wait time for the landing queue is: " << w / n << std::endl;
		...
		w = departure_queue->get_total_wait();
		n = departure_queue->get_num_served();
		std::cout << "Average wait time for the departure queue is: " << w / n << std::endl;
		std::cout << std::endl;
